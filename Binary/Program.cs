...
namespace Binary
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SynchronizedDatabase.Watermark = "TexWizard Packer | Automated";
        ...
        {
            using var logger = new Logger("MainLog.txt", "TexWizard Packer : Unknown Exception", true);
            logger.WriteException(e.Exception);

#if DEBUG
            MessageBox.Show("Unexpected error has occured. Please send MainLog.txt " +
                "file to us. Right now TexWizard Packer will export all your " +
